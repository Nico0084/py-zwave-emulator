...
class EnergyProductionCmd:
	Get		= 0x02
	Report	= 0x03

class EnergyProductionIndex:
	Instant = 0
	Total = 1
	Today = 2
	Time = 3

c_energyParameterNames = [
    "Instant energy production",
    "Total energy production",
    "Energy production today",
    "Total production time"
    ]
class EnergyProduction(CommandClass):
    
    StaticGetCommandClassId = 0x90
    StaticGetCommandClassName = "COMMAND_CLASS_ENERGY_PRODUCTION"
