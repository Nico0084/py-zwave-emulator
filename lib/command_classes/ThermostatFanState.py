...
class ThermostatFanState(CommandClass):
    
    StaticGetCommandClassId = 0x45
    StaticGetCommandClassName = "COMMAND_CLASS_THERMOSTAT_FAN_STATE"
