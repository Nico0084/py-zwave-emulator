...
c_protectionStateNames = [
    "Unprotected",
    "Protection by Sequence",
    "No Operation Possible"
    ]
    
class Protection(CommandClass):
    
    StaticGetCommandClassId = 0x75
    StaticGetCommandClassName = "COMMAND_CLASS_PROTECTION"
    ...
    def getFullNameCmd(self,  _id):
        return ProtectionCmd().getFullName(_id)
