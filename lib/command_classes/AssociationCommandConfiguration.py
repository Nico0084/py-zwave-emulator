...
class AssociationCommandConfiguration(CommandClass):
    
    StaticGetCommandClassId = 0x9b
    StaticGetCommandClassName = "COMMAND_CLASS_ASSOCIATION_COMMAND_CONFIGURATION"
