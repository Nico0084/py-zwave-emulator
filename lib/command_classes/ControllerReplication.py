...
class ControllerReplicationCmd:
	TransferGroup		= 0x31
	TransferGroupName	= 0x32
	TransferScene		= 0x33
	TransferSceneName	= 0x34

class ControllerReplicationIndex:
	NodeId = 0
	ControllerReplicationIndex_Function = 1
	ControllerReplicationIndex_Replicate = 2

c_controllerReplicationFunctionNames = [ 
    "Groups",
    "Group Names",
    "Scenes",
    "Scene Names"
...
class ControllerReplication(CommandClass):
    
    StaticGetCommandClassId = 0x21
    StaticGetCommandClassName = "COMMAND_CLASS_CONTROLLER_REPLICATION"
