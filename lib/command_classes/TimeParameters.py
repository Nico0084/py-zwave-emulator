...
class TimeParametersCmd:
	Set		= 0x01
	_Get		= 0x02
	Report	= 0x03

class TimeParametersIndex:
    Date = 0
    TimeParametersIndex_Time = 1
    TimeParametersIndex_Set = 2
    TimeParametersIndex_Refresh = 3

class TimeParameters(CommandClass):
    
    StaticGetCommandClassId = 0x8B
    StaticGetCommandClassName = "COMMAND_CLASS_TIME_PARAMETERS"
